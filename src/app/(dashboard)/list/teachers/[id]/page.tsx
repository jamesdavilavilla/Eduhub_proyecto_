            ...
            <div className="w-full xl:w-2/3">
             ...
             <div className="flex flex-col lg:flex-row gap-4">
                 ...
                 <div className="bg-EduhubSky py-6 px-4 rounded-md flex-1 flex gap-4">
                    ...
                    <h1 className="text-xl font-semibold">James Davila</h1>
                     <FormModal table="teacher" type="update" data={{
                        id:1,
                        username: "paula rodriguez",
                        email: "pmrodriguez@gmail.com",
                        password:"password",
                        firstName:"Paula",
                        lastName:"rodriguez",
                        phone:"3383747488",
                     ...
                     <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                        ...
                        <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                            ...
                            <span>jamesdavilavilla1@gmail.com</span>
                        </div>
                        <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                            <Image src="/phone.png" alt="" width={14} height={14}/>
                            <span>+57 3332681410</span>
                        </div>
                     </div>
                 ...
                 <div className="flex-1 flex gap-4 justify-between flex-wrap">
                    ...
                    <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
                        ...
                        <div className="">
                            ...
                            <span className="text-sm text-gray-400">Sucursales</span>
                        </div>
                    </div>
                    {/* CARD */}
                    <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
