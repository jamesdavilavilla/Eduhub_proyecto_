...
const renderRow = (item: LessonList) => {
  // Para mostrar solo hora:minuto en formato legible
...
const LessonListPage = async ({ searchParams }: { searchParams: { [key: string]: string | undefined } }) => {
      ...
      if (value !== undefined) {
        switch (key) {
          ...
          case "teacherId":
            ...
            break;
          case "day":
            query.day = value as any; // asumes que `day` es enum, si no ajustar
            break;
          case "search":
            query.OR = [
  ...
  // Obtener lecciones ordenadas por día y hora para simular horario
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">Horario de Lecciones</h1>
